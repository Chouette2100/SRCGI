...
tar zcvf SRCGI_$filename.tar.gz SRCGI run.sh chgLM.sh my_script.env DBConfig.yml ServerConfig.yml bots.yml nontargetentry.yml Env.yml excl.txt rvl.txt DenyIp.txt cidr.txt templates public/index.html 