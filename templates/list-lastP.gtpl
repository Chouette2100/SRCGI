...
<div style="text-align: center; margin: 20px 0;">
	<form action="list-lastP" method="get" class="hilight" style="display: inline-block; margin: 0 10px;">
		<input type="hidden" name="eventid" value="{{ .Eventid }}" />
		<input type="hidden" name="detail" value="{{.Detail}}" />
		<input type="hidden" name="page" value="{{ Add .Page -1 }}" />
		<input type="submit" value="← 前へ" {{ if le .Page 1 }}disabled style="background: #ccc;"{{ end }} />
	</form>
	
	<span style="display: inline-block; margin: 0 10px;">
		{{ .Page }} / {{ if eq .NoRooms 0 }}1{{ else }}{{ div (Add .NoRooms 19) 20 }}{{ end }} ページ
	</span>
	...
	<form action="list-lastP" method="get" class="hilight" style="display: inline-block; margin: 0 10px;">
		...
		<input type="hidden" name="detail" value="{{.Detail}}" />
		<input type="hidden" name="page" value="{{ Add .Page 1 }}" />
		<input type="submit" value="次へ →" {{ if ge .Page (div (Add .NoRooms 19) 20) }}disabled style="background: #ccc;"{{ end }} />
	</form>
</div>
